...
STATUS_COLORS = {
    ...
    'отменено': 'СЕРЫЙ',
    'перенос (ожидание клиента)': 'СВЕТЛО-ОРАНЖЕВЫЙ',
    'перенос (ожидание мастера)': 'ОРАНЖЕВЫЙ',
    'перенесена': 'СВЕТЛО-ФИОЛЕТОВЫЙ'
}
...
STATUSES = {
    ...
    'COMPLETED': 'выполнено',
    'CANCELLED': 'отменено',
    'RESCHEDULING_CLIENT': 'перенос (ожидание клиента)',
    'RESCHEDULING_MASTER': 'перенос (ожидание мастера)',
...
MASTER_STATUSES = {
    ...
    'completed': 'выполнено',
    'pending': 'ожидает',
    'rescheduling': 'перенос (ожидание мастера)',
}