...
COLUMNS = {
    ...
    'original_booking_id': 'ID исходной записи'  # ДЛЯ ПЕРЕНОСА
}
...
STATUS_COLORS = {
    ...
    'отменено': 'СЕРЫЙ',
    'перенос (ожидание клиента)': 'СВЕТЛО-ОРАНЖЕВЫЙ',  # НОВЫЙ
    'перенос (ожидание мастера)': 'ОРАНЖЕВЫЙ',         # НОВЫЙ
    'перенесена': 'СВЕТЛО-ФИОЛЕТОВЫЙ'                   # НОВЫЙ
}
...
STATUSES = {
    ...
    'COMPLETED': 'выполнено',
    'CANCELLED': 'отменено',
    'RESCHEDULING_CLIENT': 'перенос (ожидание клиента)',  # НОВЫЙ
    'RESCHEDULING_MASTER': 'перенос (ожидание мастера)',  # НОВЫЙ
    'RESCHEDULED': 'перенесена',                          # НОВЫЙ
}

# Коды статусов для мастер-панели
MASTER_STATUSES = {
    'active': 'подтверждено',      # Активные записи
    'completed': 'выполнено',      # Выполненные записи
    'pending': 'ожидает',          # Ожидающие подтверждения
    'rescheduling': 'перенос (ожидание мастера)',  # НОВЫЙ
}